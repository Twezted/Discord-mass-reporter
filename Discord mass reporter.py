...
class Main:
    def __init__(self):
        ...
        REASON = input(
            ...
            '[4] Self-harm\n'
            '[5] NSFW content\n'
            '[x] The report text and information is automatically generated based on the message ID!\n\n'
            '[>] Reason: '
        )
        ...
        if REASON.upper() in ('1', 'ILLEGAL CONTENT'):
            ...
            self.REASON = 4
        elif REASON.upper() in ('x', 'The report text and information is automatically generated based on the message ID!'):
            self.REASON = 5
        else:
            print('\n[!] Reason invalid. Please retry or double check your correction')
            os.system(
                'title [Discord Reporter https://github.com/Twezted] - Restart required &&'
                'pause >NUL &&'
                'title [Discord Reporter | By Twezted#9999] - Exiting...'
            )
            time.sleep(3)
            os._exit(0)
...
if __name__ == '__main__':
    os.system('cls && title [Discord Reporter] - https://github.com/Twezted')
    main = Main()
    main.setup()
